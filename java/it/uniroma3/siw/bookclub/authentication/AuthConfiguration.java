package it.uniroma3.siw.bookclub.authentication;
...
import static it.uniroma3.siw.bookclub.model.Credentials.ADMIN_ROLE;
...
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/", "/index", "/login", "/toRegister", "/register", "/css/**", "/images/**").permitAll()
